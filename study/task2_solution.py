...
# 'abc|', 'right' => 'abc|'
#
# Lastly, the user can type a single letter like 'p'. This inserts the
# character to the left of the cursor:
#
# 'abc|def', 'z' => 'abcz|def'
# 
# Write unit tests for the following function and fix all four bugs.
...
# bug list: bockspace, index out of bounds for left, missing case for right, missing | for else